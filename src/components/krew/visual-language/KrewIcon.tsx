...
function IconShape({ name }: { name: KrewIconName }) {
  switch (name) {
    ...
    case "transport":
      return <><path {...STROKE} d="M4.1 14.7h15.8l-1.9-4.5c-.5-1.2-1.5-1.9-2.8-2.1-2.2-.3-4.2-.3-6.4 0-1.3.2-2.3.9-2.8 2.1l-1.9 4.5Z" /><path {...STROKE} d="M3.7 14.7v3.5c0 .7.5 1.2 1.2 1.2h14.2c.7 0 1.2-.5 1.2-1.2v-3.5" /><path {...SOFT_STROKE} d="M7.1 11.1h9.8" /><circle cx="7" cy="19.3" r="1.6" fill="none" stroke="currentColor" strokeWidth="2.05" /><circle cx="17" cy="19.3" r="1.6" fill="none" stroke="currentColor" strokeWidth="2.05" /></>;
    case "planning":
    ...
    case "budget":
      return <><path {...STROKE} d="M4.6 7.3c4.2-.5 9.8-.5 14 0v11.4c-4.2.5-9.8.5-14 0V7.3Z" /><path {...STROKE} d="M13.2 10.3h6.3v5.4h-6.3c-1.5 0-2.6-1.1-2.6-2.7 0-1.6 1.1-2.7 2.6-2.7Z" /><Dot cx={16.2} cy={13} r={1.1} /><path {...SOFT_STROKE} d="M7 9.7h3.1" /></>;
  }
}
