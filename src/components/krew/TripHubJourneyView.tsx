...
type TripHubJourneyViewProps = {
  ...
  tripLifecycle: "upcoming" | "live" | "completed";
  costSplitData: any;
};
    ...
    const timelineSteps: TimelineStep[] = [
      {
        ...
        subtitle: datesLocked
          ? "Dates confirmées"
          : `${availData?.answered ?? 0}/${totalParts} indiquées`,
    ...
    timelineSteps.push(
      ...
      },
      {
        ...
        subtitle: profile?.selectedConcepts?.length
          ? profile.selectedConcepts
              .map((concept: any) => PROFILE_LABELS[concept.id as StayProfileId] || concept.title)
              .join(" · ")
          : profileDone
            ? "Profil enregistré"
            : "À choisir",
      ...
      },
      {
        ...
        subtitle:
          ...
          (recommendations.length > 0 ? "Propositions prêtes" : "En attente de choix"),
