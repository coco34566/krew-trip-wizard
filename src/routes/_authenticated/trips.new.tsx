  ...
  return (
    <main className="mx-auto max-w-xl px-4 py-10">
      ...
      <div className="mt-6 rounded-3xl border border-border bg-card p-6 shadow-sm sm:p-8">
        ...
        <p className="mt-2 text-sm text-muted-foreground">Juste l'essentiel pour démarrer. Les dispos, préférences et la destination viennent ensuite avec le groupe.</p>
