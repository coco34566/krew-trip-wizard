...
export const Route = createFileRoute("/_authenticated/trips/$tripId/")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "Compare les propositions et avance avec ton groupe." },
...
function TripDetail() {
  ...
  const actions = useTripHubActions({
    tripId,
    onParticipantsCountUpdated: () => setIsEditingCount(false),
  });
      ...
      {currentView === "todo" ? (
        <div className="space-y-8">
          ...
          <TripHubMembersSection
            ...
            actions={actions}
            buildWhatsAppRemindMessage={buildWhatsAppRemindMessage}
          />
