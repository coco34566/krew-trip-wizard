...
export const QUESTIONNAIRE_SIGNAL_MAPPING: QuestionnaireSignalUse[] = [
  { field: "budget_max + budget_priority", source: "trip_participant_preferences", hardConstraint: false, scoringFactor: true, apiQuery: true, tieBreaker: true, explanation: true, currentUse: "médiane groupe, pénalité et avertissement lorsqu'un budget individuel risque d'être dépassé, sans veto sur le groupe" },
